...
class AdminRoomController extends Controller
{
    ...
    {
        $rooms = Room::get();
        return view('admin.rooms.room_view', compact('rooms'));
    }

    public function add()
    {
        $all_amenities = Amenity::get();
        return view('admin.rooms.room_add',compact('all_amenities'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $obj->total_children = $request->total_children;
    ...
    public function edit($id)
    {
        ...
        return view('admin.rooms.room_edit', compact('room_data','all_amenities','existing_amenities'));
    }
    ...
    public function gallery($id)
    {
        ...
        return view('admin.rooms.room_gallery', compact('room_data','room_photos'));
    }
