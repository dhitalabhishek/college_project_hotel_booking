...
class AdminAmenityController extends Controller
{
    public function index()
    {
        ...
        return view('admin.rooms.amenities.amenity_view', compact('amenities'));
    }

    public function add()
    {
        return view('admin.rooms.amenities.amenity_add');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.rooms.amenities.amenity_edit', compact('amenity_data'));
    }
