...
class AdminPageController extends Controller
{
    ...
    {
        $page_data = Page::where('id',1)->first();
        return view('admin.pages.page_terms', compact('page_data'));
    }
    ...
    {
        $page_data = Page::where('id',1)->first();
        return view('admin.pages.page_privacy', compact('page_data'));
    }
    ...
    {
        $page_data = Page::where('id',1)->first();
        return view('admin.pages.page_photo_gallery', compact('page_data'));
    }
    ...
    {
        $page_data = Page::where('id',1)->first();
        return view('admin.pages.page_video_gallery', compact('page_data'));
    }
    ...
    {
        $page_data = Page::where('id',1)->first();
        return view('admin.pages.page_blog', compact('page_data'));
    }
    ...
    {
        $page_data = Page::where('id',1)->first();
        return view('admin.pages.page_room', compact('page_data'));
    }
    ...
    {
        $page_data = Page::where('id',1)->first();
        return view('admin.pages.page_cart', compact('page_data'));
    }
    ...
    {
        $page_data = Page::where('id',1)->first();
        return view('admin.pages.page_checkout', compact('page_data'));
    }
    ...
    {
        $page_data = Page::where('id',1)->first();
        return view('admin.pages.page_payment', compact('page_data'));
    }
    ...
    {
        $page_data = Page::where('id',1)->first();
        return view('admin.pages.page_signup', compact('page_data'));
    }
    ...
    {
        $page_data = Page::where('id',1)->first();
        return view('admin.pages.page_signin', compact('page_data'));
    }
    ...
    {
        $page_data = Page::where('id',1)->first();
        return view('admin.pages.page_forget_password', compact('page_data'));
    }
    ...
    {
        $page_data = Page::where('id',1)->first();
        return view('admin.pages.page_reset_password', compact('page_data'));
    }
