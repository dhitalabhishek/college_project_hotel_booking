                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    @foreach($all_amenities as $item)
                                        <div class="form-check">
                                            <input class="form-check-input" {{ in_array($item->id,$existing_amenities) ? 'checked' : ''}}
                                            type="checkbox" value="{{ $item->id }}" id="defaultCheck{{ $item->id }}" name="arr_amenities[]" >
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="total_children" value="{{ $room_data->total_children }}">
                                </div>
                                @if($room_data->video_id != null)
                                <div class="mb-4">
