                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pt_10 pb_10">
                                        @if($row->feedbacks()->count() > 0)
                                        <button class="btn btn-info" data-toggle="modal" data-target="#feedback{{ $i }}">Feedback</button>
                                        @endif
                                ...
                                @if($row->feedbacks()->count() > 0)
                                <div class="modal fade" id="feedback{{ $i }}" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Room Feedback</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">×</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group row bdb1 pt_10 mb_0">
                                                    <div class="col-md-4"><label class="form-label">Customer Name</label></div>
                                                    <div class="col-md-8">{{ $feedback->customer->name }}</div>
                                                </div>
                                                <div class="form-group row bdb1 pt_10 mb_0">
                                                    <div class="col-md-4"><label class="form-label">Rating</label></div>
                                                    <div class="col-md-8">${{ $feedback->rating }}</div>
                                                </div>
                                                <div class="form-group row bdb1 pt_10 mb_0">
                                                    <div class="col-md-4"><label class="form-label">Feedback</label></div>
